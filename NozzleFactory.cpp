...
HComponent* NozzleFactory::createEmptyNozzle(HComposition composition, QString description, double xref, double yref, double zref, double radius)
{
    ...
    nozzle->setType("de.hykops.nozzle.default"); //type def finden/machen/tun!!!----------------------------------
